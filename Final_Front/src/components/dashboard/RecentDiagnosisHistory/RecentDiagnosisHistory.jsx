...
const RecentDiagnosisHistory = () => {
  ...
  if (diagnoses.length === 0) {
    return (
      <div className="flex items-center justify-center h-full min-h-[300px]">
        <div className="text-slate-500 text-sm">최근 진단 이력이 없습니다.</div>
      </div>
    );
  }
          ...
          {diagnoses.map((diagnosis) => {
            ...
            return (
              <tr
                ...
                className="even:bg-slate-50/60 hover:bg-blue-50/50 cursor-pointer transition-colors border-b border-slate-100"
              >
